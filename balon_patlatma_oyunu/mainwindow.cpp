...
void MainWindow::ButonCagirma(int satir)
{
    ...
    {
        case 0:
        kdm_tus->setStyleSheet("border-image:url(:/images/images/0.jpg);");
        break;

        case 1:
        kdm_tus->setStyleSheet("border-image:url(:/images/images/1.jpg);");
        break;

        case 2:
        kdm_tus->setStyleSheet("border-image:url(:/images/images/2.jpg);");
        break;

        case 3:
        kdm_tus->setStyleSheet("border-image:url(:/images/images/3.jpg);");
        break;

        case 4:
        kdm_tus->setStyleSheet("border-image:url(:/images/images/4.jpg);");
        break;

        case 5:
        kdm_tus->setStyleSheet("border-image:url(:/images/images/5.jpg);");
        break;

        case 6:
        kdm_tus->setStyleSheet("border-image:url(:/images/images/6.jpg);");
        break;
...
void MainWindow::balonindir()
{
    ...
    for (int i = 0; i < sayisi; ++i)
    {
        if(grkltus[i])
        {
            ...
            if(grkltus[i]->dgdm)
            {
                grkltus[i]->setStyleSheet("border-image:url(:/images/images/patlama.jpg);");
                bumbe +=1;
